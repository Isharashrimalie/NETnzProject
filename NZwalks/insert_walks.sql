-- Insert sample walks data directly into the database
-- Make sure to run this against the NZWalksDb database
...
SELECT COUNT(*) as TotalWalks FROM Walks;

-- Show the walks with their related data
SELECT 
    w.Name,
    w.Description,
    w.LengthInKm,
    ...
    r.Name as Region
FROM Walks w
LEFT JOIN Difficulties d ON w.DifficulityId = d.Id
